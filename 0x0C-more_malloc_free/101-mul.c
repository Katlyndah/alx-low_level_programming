...
/**
 * _atoi_digit -> function that converts a char to an integer.
...
/**
 * _isNumber -> function that defines if a string is a number.
...
/**
 * _calloc -> function that allocates an array of size * nmemb.
...
/**
 * mul_array -> function that multiplies two arrays.
 * @a1: first array
...
/**
 * print_array -> function that prints all digits of an array.
...
/**
 * main -> function that prints the multiplication of 2 numbers.
 * @argc: array length.
 * @argv: array.
 * Return: 0.
 */
